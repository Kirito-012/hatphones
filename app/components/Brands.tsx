...
import { Smartphone, Tablet, Watch, Laptop, Headphones, MonitorSmartphone } from "lucide-react";
...
const brands = [
  ...
  { name: "MacBooks & PCs", icon: Laptop, color: "text-zinc-600 dark:text-zinc-400", bg: "bg-zinc-100 dark:bg-zinc-800" },
  { name: "Smartwatches", icon: Watch, color: "text-rose-600 dark:text-rose-400", bg: "bg-rose-50 dark:bg-rose-500/10" },
